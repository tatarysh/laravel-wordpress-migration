...
class CreateWordpressCommentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::connection($this->connection())->create('comments', static function (Blueprint $table) {
    ...
    {
        Schema::connection($this->connection())->drop('comments');
    }
}
